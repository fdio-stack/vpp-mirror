...
typedef struct _tcp_cc_algorithm
{
...
always_inline u32
tcp_flight_size (tcp_connection_t *tc)
{
 ...
 */
u32
tcp_initial_cwnd (tcp_connection_t *tc)
{
  if (tc->snd_mss > 2190)
    return 2 * tc->snd_mss;
...
u32
tcp_loss_wnd (tcp_connection_t *tc)
{
  return tc->snd_mss;
}
...
void
tcp_register_cc_algo (tcp_cc_algorithm_type_e type,
